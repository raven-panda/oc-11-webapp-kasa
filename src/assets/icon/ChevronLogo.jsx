...
export default function ChevronLogo({
  ...
  return (
    <svg className={styles.rotation_animated} width={width} height={height} style={{ rotate: rotate + 'deg' }} viewBox="0 0 33 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
